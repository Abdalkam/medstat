  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (storedPassword && currentPassword !== storedPassword) {
        return setPasswordMessage("Current password is incorrect.");
      }
    ...
    return (
      <div style={{ padding: "24px 16px 80px 16px", maxWidth: "600px", margin: "0 auto", fontFamily: iosFont }}>
        ...
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} style={{ marginBottom: "24px" }}>
            <div style={{ width: "35%", height: "12px", borderRadius: "4px", background: "#E5E5EA", animation: "pulse 1.5s infinite", marginLeft: "4px", marginBottom: "8px" }}></div>
            <div style={{ width: "100%", height: "88px", borderRadius: "14px", background: "#E5E5EA", animation: "pulse 1.5s infinite 0.1s" }}></div>
          </div>
        ))}
        <div style={{ width: "100%", height: "52px", borderRadius: "14px", background: "#E5E5EA", animation: "pulse 1.5s infinite 0.2s" }}></div>
      </div>
    );
  }
    ...
    <div style={{ padding: "24px 16px 80px 16px", maxWidth: "600px", margin: "0 auto", fontFamily: iosFont }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <input
          ...
          style={{ width: "100%", padding: "16px", marginTop: "8px", borderRadius: "14px", border: "none", background: C.card, boxShadow: "0 1px 3px rgba(0,0,0,0.05)", fontSize: "16px", color: C.textPrimary, outline: "none", boxSizing: "border-box" }}
        />
      </div>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <textarea
          ...
          rows={3}
          style={{ width: "100%", padding: "16px", marginTop: "8px", borderRadius: "14px", border: "none", background: C.card, boxShadow: "0 1px 3px rgba(0,0,0,0.05)", fontSize: "16px", color: C.textPrimary, outline: "none", boxSizing: "border-box", resize: "none", fontFamily: "inherit" }}
        />
      </div>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <div style={{ background: C.card, borderRadius: "14px", padding: "16px", marginTop: "8px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            {logo ? (
              <img src={logo} alt="Logo" style={{ width: "56px", height: "56px", borderRadius: "12px", objectFit: "cover" }} />
            ) : (
              <div style={{ width: "56px", height: "56px", borderRadius: "12px", background: "#F2F2F7", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div>
              <p style={{ margin: 0, fontSize: "16px", color: C.textPrimary, fontWeight: "500" }}>{logo ? "Logo uploaded" : "No logo uploaded"}</p>
              <p style={{ margin: 0, fontSize: "13px", color: C.textTertiary }}>PNG or JPG recommended</p>
            </div>
          </div>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <div style={{ background: C.card, borderRadius: "14px", padding: "16px", marginTop: "8px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            {loginBackground ? (
              <img src={loginBackground} alt="Background" style={{ width: "80px", height: "56px", borderRadius: "12px", objectFit: "cover" }} />
            ) : (
              <div style={{ width: "80px", height: "56px", borderRadius: "12px", background: "#F2F2F7", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#AEAEB2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" /></svg>
              </div>
            )}
            <div>
              <p style={{ margin: 0, fontSize: "16px", color: C.textPrimary, fontWeight: "500" }}>{loginBackground ? "Background uploaded" : "No background uploaded"}</p>
              <p style={{ margin: 0, fontSize: "13px", color: C.textTertiary }}>Shown behind login card</p>
            </div>
          </div>
      ...
      <button
        onClick={handleSave}
        disabled={saving}
        style={{ width: "100%", padding: "16px", background: C.blue, color: "#fff", border: "none", borderRadius: "14px", fontSize: "17px", fontWeight: "600", cursor: "pointer", opacity: saving ? 0.5 : 1, marginBottom: "24px" }}
      >
      ...
      <div style={{ marginBottom: "24px" }}>
        {!showPasswordSection ? (
          <button
            ...
            style={{ width: "100%", padding: "16px", background: C.redBg, color: C.red, border: "1px solid rgba(255,59,48,0.2)", borderRadius: "14px", fontSize: "17px", fontWeight: "600", cursor: "pointer" }}
          >
            Change Password
          </button>
        ) : (
          <div style={{ background: C.card, borderRadius: "14px", overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: "14px 16px", borderBottom: `0.5px solid ${C.separator}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button
                onClick={() => { setShowPasswordSection(false); setPasswordMessage(""); setCurrentPassword(""); setNewPassword(""); setConfirmPassword(""); }}
                style={{ background: "none", border: "none", color: C.textTertiary, fontSize: "24px", cursor: "pointer", lineHeight: 1, padding: "0 4px" }}
              >&times;</button>
            </div>
            <div style={{ padding: "4px 16px 16px 16px" }}>
              ...
              {passwordMessage && (
                <p style={{ fontSize: "14px", marginBottom: "12px", fontWeight: "500", textAlign: "center", color: passwordMessage.includes("success") ? C.green : C.red }}>
                  {passwordMessage}
                </p>
              )}
              <button
                ...
                style={{ width: "100%", padding: "14px", background: C.blue, color: "#fff", border: "none", borderRadius: "12px", fontSize: "17px", fontWeight: "600", cursor: changingPassword ? "not-allowed" : "pointer", opacity: changingPassword ? 0.5 : 1 }}
              >
